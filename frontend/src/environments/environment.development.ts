export const environment = {
    registrationURL:'http://localhost:3500/registration/register',
    loginURL:'http://localhost:3500/login/login',
    resultsURL:'http://localhost:3500/results/results',
    namesURL:'http://localhost:3500/meetRegistration/names',
